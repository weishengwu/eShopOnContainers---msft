...
This is the archived wiki page for AKS related deployment.
If you are planning to use the latest versions, you can refer to [latest wiki page](Deploy-to-Azure-Kubernetes-Service-(AKS))
...
![image](./images/Deploy-to-Azure-Kubernetes-Service-(AKS)-Archived/create-kubernetes-cluster-basics.png)

- Then, very important, in the next step, enable RBAC:

![image](./images/Deploy-to-Azure-Kubernetes-Service-(AKS)-Archived/create-kubernetes-cluster-authentication.png)
...
![image](./images/Deploy-to-Azure-Kubernetes-Service-(AKS)-Archived/create-kubernetes-cluster-networking.png)

- You can also enable monitoring:

![image](./images/Deploy-to-Azure-Kubernetes-Service-(AKS)-Archived/create-kubernetes-cluster-monitoring.png)
...
![image](./images/Deploy-to-Azure-Kubernetes-Service-(AKS)-Archived/rbac-kubernetes-dashboard.png)
...
![image](./images/Deploy-to-Azure-Kubernetes-Service-(AKS)-Archived/command-to-kubernetes-dashboard.png)
...
![image](./images/Deploy-to-Azure-Kubernetes-Service-(AKS)-Archived/kubernetes-dashboard.png)
...
![Pods with two containers](./images/Deploy-to-Azure-Kubernetes-Service-(AKS)-Archived/pods.png)
