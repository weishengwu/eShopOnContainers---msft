...
You can watch the deployment unfold from the Kubernetes web interface: 
run `kubectl proxy` and open a browser to [localhost:8001/#!/deployment](localhost:8001/#!/deployment)
